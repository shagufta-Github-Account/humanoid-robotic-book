...
const config: Config = {
  ...
  customFields: {
   apiUrl: process.env.REACT_APP_API_URL || 'web-production-4bacfd.up.railway.app', 
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/shagufta-Github-Account',
        },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/shagufta-Github-Account',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'shagufta GitHub',
              href: 'https://github.com/shagufta-Github-Account',
            },
            {
              label: 'LinkedIn',
              href: 'https://www.linkedin.com/in/shagufta-khan-165566295/',
            },
          ],
        },
        {
